...
using Teste_Paschoalott_Back_End.Services;

namespace Teste_Paschoalott_Back_End
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Teste_Paschoalott_Back_End", Version = "v1" });
            });
        }
